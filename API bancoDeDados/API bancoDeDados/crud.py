...
class PostgreSQLCRUD:
    ...
    def criar_tabela_enderecos(self):
            try:
    ...
    def criar_tabela_prestadores(self):
        try:
            ...
            CREATE TABLE IF NOT EXISTS prestadores (
                ...
                FOREIGN KEY (tipo_prestador) REFERENCES tipo(tipo),
    ...
    def criar_tabela_comentarios(self):
        try:
            cursor = self.conn.cursor()
    ...
    def criar_tabela_solicitacoes(self):
        try:
            cursor = self.conn.cursor()
